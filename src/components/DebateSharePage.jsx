  ...
  return (
    <div className="min-h-screen bg-gray-950 text-gray-100 font-sans">
      ...
      <main className="max-w-2xl mx-auto px-4 sm:px-6 py-6 space-y-6">
        ...
        {/* Explanation banner */}
        <div className="rounded-xl border border-indigo-800/40 bg-indigo-950/30 px-4 py-3 flex flex-col sm:flex-row sm:items-center gap-3">
          <p className="text-sm text-indigo-200/80 flex-1">
            This debate was generated by <span className="font-semibold text-indigo-300">AI Debate Studio</span> — watch AI personas debate live with spoken voices and generated images. Create your own debates between historical figures, scientists, politicians, and philosophers.
          </p>
          <a
            href="/#signup"
            className="shrink-0 px-4 py-2 rounded-lg bg-indigo-600 hover:bg-indigo-500 text-sm font-semibold text-white transition-colors text-center"
          >
            Try it free →
          </a>
        </div>
        ...
        <div>
          ...
          <div className="space-y-3">
            {messages.map((msg) => (
              ...
              >
                {msg.image_url && (
                  <img src={msg.image_url} alt="" className="w-full max-h-56 object-cover" />
                )}
                <div className="p-3">
        ...
        {/* Bottom CTA */}
        <div className="rounded-2xl border border-gray-700/60 bg-gray-900/80 p-6 text-center space-y-3">
          <p className="text-base font-semibold text-white">Create your own AI debate</p>
          <p className="text-sm text-gray-400">Pick any two figures, any topic. Watch them argue live with AI-generated voices and images.</p>
          <div className="flex flex-col sm:flex-row gap-2 justify-center pt-1">
            <a
              href="/#signup"
              className="px-6 py-2.5 rounded-lg bg-indigo-600 hover:bg-indigo-500 text-sm font-semibold text-white transition-colors"
            >
              Start free — no card required
            </a>
            <Link
              to="/"
              className="px-6 py-2.5 rounded-lg border border-gray-700 bg-gray-800/60 hover:bg-gray-800 text-sm font-medium text-gray-300 transition-colors"
            >
              See how it works
            </Link>
          </div>
